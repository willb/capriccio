...
*/
sealed class Sink(private var _count: Long, private var _min: Double, private var _max: Double, private var _mean: Double, private var _m2: Double) {
...
object Sink {
  def empty: Sink = new Sink(0, Double.PositiveInfinity, Double.NegativeInfinity, 0.0d, 0.0d)
}
